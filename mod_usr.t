...
!
  ...
  double precision :: eta0_pre=5.d-3, r_eta_pre=0.024d0, h_eta_pre=0.5d0
  ! IMPULSIVE phase variables
  double precision :: t_imp=5.98d2/7.7829146115813d1, eta0_imp=3.d-2, r_eta_imp=0.024d0, h_eta_imp=0.5d0
  ! PARTICLE ACCELERATION phase variables
  double precision :: t_acc=6.0d2/7.7829146115813d1, alpha_acc=2.d-4, h_eta_acc=0.5d0, h_s_acc=0.1d0, v_c_acc=1.d3, eta_max_acc=2.d-1
...
!    write(*,*) "begin init_Bfield",mype
    ...
    heta=0.5d0    ! height of eta central location h_eta in eq 11, Ruan 2020
    heta2=0.1d0   ! decay length from central eta location h_s in eq 11, Ruan 2020
